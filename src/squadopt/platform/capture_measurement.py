...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.out.resolve().is_relative_to(args.snapshot_root.resolve()):
        parser.error("Measurement output must be outside the capture archive.")
    if args.early_snapshot or args.late_snapshot or args.gameweek is not None:
