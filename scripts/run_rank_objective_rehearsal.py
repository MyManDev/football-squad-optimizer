...
def _markdown(result: RankRehearsalResult, provenance: Mapping[str, object]) -> str:
    lines = [
        ...
        "scenario probability of finishing ahead; realized = share of folds it actually did.",
        "",
        "| Budget (xP) | Folds | Claimed P(ahead) | Realized ahead [90%] | Expected cost | "
        "Realized cost | Starters changed | Captain changed | Proven |",
        "| ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: |",
    ]
