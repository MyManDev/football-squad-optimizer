...
- Per-fold solves stop at a deterministic work budget (2.0); the trace is machine-independent for identical inputs
- Search space: 616 candidates; evaluated 12
- Stopped: evaluation_budget_exhausted
- Run fingerprint: `5a03758270b6543e821cc228cc2812683a255954374af05fdeeffd378f554db8`
...
| --- | --- | --- | --- |
| 0 | initial_design | `bench_weight=0.25-form_window=9-risk_aversion=0.6` | 44.2162 |
| 1 | initial_design | `bench_weight=0-form_window=3-risk_aversion=0` | 53.1622 |
| 2 | initial_design | `bench_weight=0.1-form_window=3-risk_aversion=1` | 17.7568 |
| 3 | initial_design | `bench_weight=0.3-form_window=3-risk_aversion=0.1` | 43.7297 |
...
| 11 | expected_improvement | `bench_weight=0-form_window=10-risk_aversion=0.5` | 44.5946 |
