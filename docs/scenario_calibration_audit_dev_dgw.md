...
- Selection shift: development (mean -36.32 pts); double-gameweek scale 1.45

## Decision-level calibration

| Question | Scenario claim | Reality | Verdict basis |
| --- | ---: | ---: | --- |
| Realized below scenario q10% | 0.10 | 0.16 | calibrated if close |
| Mean PIT (uniform target 0.50) | 0.50 | 0.55 | bias if far from 0.5 |
| PIT < 0.10 rate | 0.10 | 0.14 | lower-tail honesty |
| PIT > 0.90 rate | 0.10 | 0.14 | upper-tail honesty |
| Bad week P(score < 40) | 0.22 | 0.14 | reliability |
| Scenario mean minus realized | 0.00 | -1.86 | location bias |
