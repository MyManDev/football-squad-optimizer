...
Start with the [documentation guide](../README.md) for product, operations, research and architecture.
...
- The export is deterministic and create-once; the record is in
  [`phase_b_evidence_contract.md`](../phase_b_evidence_contract.md).
...
- Full record: [`docs/phase_c_component_evaluation.md`](../phase_c_component_evaluation.md).
