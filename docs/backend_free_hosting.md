...
- **The shortcut starts the processes at logon after logoff or reboot.** `scripts\start_backend_at_logon.ps1`
  ...
  worktree cannot start the backend. The shortcut does not run on resume from sleep.
