...
the same pre-deadline publication rule. A price and its limit are shown only when
the record carries them. The published path identifies a row but is not displayed.
