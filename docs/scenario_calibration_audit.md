...
| --- | ---: | ---: | --- |
| Realized below scenario q10% | 0.10 | 0.78 | calibrated if close |
| Mean PIT (uniform target 0.50) | 0.50 | 0.07 | bias if far from 0.5 |
...
| Scenario mean minus realized | 0.00 | +34.48 | location bias |
