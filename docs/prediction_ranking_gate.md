...
| `prior_minutes_level` | Unestablished: no position-rank reading in the record. | Correction-eligible/touched-row MAE 1.0607 vs 1.0795 is inside the band on that subset; it is not full-roster MAE. Full-roster seasonal/pooled errors remain unestablished. | Mean −0.218, interval [−0.830, +0.313], two losing seasons: fails. 107/147 ties do not establish benefit. | **Fails** on the known decision reading, with rank/error gaps explicit. Original remains **failed**. No changed-index rerun is permitted. |
