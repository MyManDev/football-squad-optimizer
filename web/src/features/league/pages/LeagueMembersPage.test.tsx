...
describe("league member points", () => {
  ...
  it.each([
    ...
    { movement: "same", movement_places: 0, rank: 0 },
    { movement: "same", movement_places: 0, rank: -1 },
    { movement: "same", movement_places: 0, rank: 1.5 },
    { movement: "unknown", movement_places: null, rank: -1 },
