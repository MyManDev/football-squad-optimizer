...
const en = {
  ...
  leagueMembers: {
    ...
    afterGameweek: (gameweek: number) => `after gameweek ${gameweek}`,
    ...
    movementLabel: (movement: "up" | "down" | "same", places: number) =>
      movement === "same"
        ? "unchanged"
        : `${movement === "up" ? "up" : "down"} ${places} place${places === 1 ? "" : "s"}`,
    aboutTable: "About this table",
    ...
    chipLine: {
      available: "ready",
      used: (gameweek: number) => `used · gameweek ${gameweek}`,
      expired: "expired",
      not_yet: "not open yet",
      unknown: "unknown",
    },
    followerLabel: "Chasing you:",
    followerBehind: (points: string) => `${points} point${points === "1" ? "" : "s"} behind.`,
    followerLevel: "level on points.",
    chipStrategy: {
      title: "Chip strategy",
...
const tr: MessageSchema<typeof en> = {
  ...
  shell: {
    ...
    collapseSidebar: "Kenar çubuğunu kapat",
  ...
  leagueMembers: {
    ...
    afterGameweek: (gameweek) => `${gameweek}. hafta sonunda`,
    ...
    movementLabel: (movement, places) =>
      movement === "same"
        ? "yerinde kaldı"
        : `${places} sıra ${movement === "up" ? "yükseldi" : "düştü"}`,
    aboutTable: "Tablo hakkında",
    ...
    chipLine: {
      available: "hazır",
      used: (gameweek) => `kullanıldı · ${gameweek}. hafta`,
      expired: "süresi doldu",
      not_yet: "henüz açılmadı",
      unknown: "bilinmiyor",
    },
    followerLabel: "Takipçin:",
    followerBehind: (points) => `${points} puan geride.`,
    followerLevel: "aynı puanda.",
    chipStrategy: {
