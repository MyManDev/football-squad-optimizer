...
const en = {
  suggestionHistory: {
    ...
    playerNote:
      "Expected and actual are each player's unmultiplied points. Counted points include the captain multiplier and automatic substitutions.",
...
const tr: MessageSchema<typeof en> = {
  suggestionHistory: {
    ...
    minutes: "Dakika",
    multiplier: "Çarpan",
    counted: "Sayılan puan",
    playerNote:
      "Beklenen ve gerçekleşen değerler oyuncunun çarpansız puanıdır. Sayılan puana kaptan çarpanı ve otomatik yedek değişiklikleri dahildir.",
